    ...
    >
      <section>
        ...
        <div class="row">
          <div class="sm-3"></div>
          <div class="sm-9">
            ${t.authors?"<p>"+t.authors+"</p>":""}
            ${t.description?"<p>"+t.description+"</p>":""} 
            ${t.date?"<p>Published "+t.date+"</p>":""}
            ${t.id?`<div class="fake-link">${t.id}</div>`:""}
          </div>
        </div>
      </section>
    </a>
    `}function w(t,e,s,i){return`
    <div class="t3ce frame-type-gridelements_pi1">
      <div class="grid-background--white grid-background--boxed">
        ${e&&e.length&&s?s+" results":e&&e.length?"Top 3 results":"No results"}
        <h2>${t}</h2>
        <div class="content-container">
          ${e&&e.length?e.map(b).join(`
`):""} 
          <div class="t3ce frame-type-sitetud_singlebutton">
            <a href="${i}" target=_blank class="btn btn--single align-center btn--royal_blue">
              View all results ↗
            </a>
          </div>
        </div>
    ...
    `}async function u(t){let e=document.querySelector(".multiRowGrid");if(e){let s=document.querySelector("div.hiddenSidebarContent");if(s){let i=s.innerHTML.split("</form>")[1].trim();s.innerHTML=s.innerHTML.split("</form>")[0];let a=e.querySelector(".sm-12 > .t3ce");if(a){let n=a.querySelector("h2");if(n)n.innerHTML="This website";a.prepend(i?i:"No results")}}d.forEach(({id:i,title:a},n)=>{let r=document.createElement("div");if(r.className="sm-6 md-6 lg-6",r.id=i,r.innerHTML=`
      <div class="t3ce frame-type-gridelements_pi1">
        <div class="grid-background--white grid-background--boxed">
      ...
      </div>`,n===0)e.prepend(r);else e.appendChild(r)}),d.map(async(i)=>{let a=await i.getRecords(t),n=w(i.title,a,a?.count,i.searchBaseUrl+t),r=document.querySelector("#"+i.id);if(r)r.innerHTML=n})}}window.onload=()=>{let{value:t}=document.querySelector(".searchForm-input");u(t)};
