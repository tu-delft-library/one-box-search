...
var databases_default = [
  ...
  },
  {
    ...
    keywords: "Decision making; Law; Legislation; Management",
    description: "Aanbestedingsrecht (procurement process) supports the entire team involved in procurement and their advisers in their tendering processes. The site contains a knowledge database, models and checklists, expert services, and an ARW tool (Aanbestedingsreglement Werken; Procurement Rules).",
    type: "reference"
  },
  {
    title: "AERADE Reports Archive",
    access: "",
    url: "https://reports.aerade.cranfield.ac.uk/",
    keywords: "Aeronautical engineering; Aerospace; Aeronautics and aircraft; Space technology",
  ...
  },
  {
    ...
    keywords: "Geodesy; Geographical information",
    description: "The Actueel Hoogtebestand Nederland (AHN) is the digital elevation map for the whole of the Netherlands. It contains detailed and precise elevation data with an average of eight elevation measurements per square meter. The AHN is used for many purposes, for example flood management; daily management and maintenance of dikes, making specifications for major maintenance, 3D mapping, licensing and enforcement. Municipalities, companies and researchers also make use of the detailed height data. For example, archaeologists have identified old settlements that were not noticeable to the naked eye, based on small height differences in meadows. The digital elevation map can be searched through a web-based viewer. Searches can performed using names and zip codes.",
    type: "research data"
  },
  {
    title: "Altmetric Explorer for Institutions",
    access: "",
    url: "https://www.altmetric.com/explorer/login",
    keywords: "Science, technology and society; Scientific research",
    description: "Altmetric Explorer for Institutions (Altmetric EFI) provides advanced and customizable options for researchers, faculty, staff, and students looking to track altmetrics attention associated with their scholarly outputs. Altmetric Explorer pulls its data from several sources, including (but not limited to) policy and patent citations, as well as news and social media mentions. Search results from Dimensions (https://app.dimensions.ai/) can also be easily transferred to Altmetric EFI. It is possible to drill down to view the output of faculties, departments, sections, etc., down to individual researchers at TU Delft.",
    type: "articles"
  },
  {
    title: "AMBDAS: Atomic and Molecular Bibliographic Data System",
    access: "",
    url: "https://www-amdis.iaea.org/AMBDAS/",
    keywords: "Atomic and molecular physics; Nuclear physics; Nuclear reactors and reactor physics",
    description: "Atomic and Molecular Bibliographic Data System (AMBDAS) contains numerical data on atomic and molecular collisions, radiative processes and various other material properties of specific use in fusion and plasma research. Searching the database produces bibliographic results linking to the research paper containing the data of interest. Searches can be performed based on a variety of parameters including reactants, surface of interest, data type; or by date, journal or author.",
    type: "articles"
  },
  {
    title: "Archidat Bouwinformatie",
    access: "Access from Bouwformatie. Free registration.",
    url: "https://www.archidat.nl/",
    keywords: "Architecture; Building technology and construction process",
    description: "Archidat Bouwinformatie is a website providing current information on architecture and construction techniques. Through the sections Bouwdetails (Building Details) and Bouwkosten (building costs) you can browse and search for building details, products and costs. For access to Bouwdetails and Bouwkosten a free registration is required.",
    type: "reference"
  },
  {
    title: "Archieven.nl",
    access: "",
    url: "https://www.archieven.nl/en/",
    keywords: "Science, technology and society; History of science and technology",
    description: "Archieven.nl is the home page for Dutch archival research: it contains a vast number of archives and collections with milllions of document and item descriptions, often including links to full-text archival documents, as well as a pictures archive, national and regional newspaper articles, and collected address information of historical institutions.",
    type: "reference"
  },
  {
    title: "Artstor",
    ...
    keywords: "Architecture; Design; Design history",
    description: "Artstor features millions of high-quality images and media from some of the world’s top photo archives, museums, libraries, scholars, and artists, including rare materials not available anywhere else. Artstor’s collections also include Open Access collections from partner museums freely available to all. All content in Artstor is rights-cleared for education and research - you are free to use it in classroom instruction and handouts, presentations, student assignments, and other noncommercial educational and scholarly activities.",
    type: "reference"
  },
  {
    title: "ArXiv",
    access: "",
    url: "https://arxiv.org/",
    keywords: "Information science; Mathematics; Biomathematics and bioinformatics; Probability, statistics",
  ...
  },
  {
    ...
    keywords: "Materials degradation, corrosion; Materials engineering; Materials research",
    description: "Online access to ASTM (American Society of the International Association for Testing and Materials) standards and more.",
    type: "standards"
  },
  {
    title: "Atomic Spectral Line Broadening Bibliographic Database",
    access: "",
    url: "https://physics.nist.gov/cgi-bin/ASBib1/LineBroadBib.cgi",
    keywords: "Atomic and molecular physics",
    description: "This database contains references to publications that include numerical data, general information, comments, and reviews on atomic line broadening and shifts, and is part of the collection of the NIST Atomic Spectroscopy Data Center. This Data Center also maintains another two bibliographic databases: NIST Atomic Transition Probability Bibliographic Database and NIST Atomic Energy Levels and Spectra Bibliographic Database. References to publications containing critically compiled data can be found in a separate database of NIST compilations of atomic spectroscopy data.",
    type: "articles"
  },
  {
  ...
  },
  {
    ...
    keywords: "Scientific research",
    description: "Bielefeld Academic Search Engine (BASE), operated by Bielefeld University Library, is a leading search engine for academic web resources. It indexes over 400 million documents from more than 10,000 content providers, including journals, institutional repositories, and digital collections. Approximately 60% of the indexed documents are freely accessible as Open Access full texts. BASE covers a wide range of academic disciplines and resource types, making it a comprehensive tool for scholarly research.",
    type: "articles"
  },
  {
    title: "Beeld en Geluid",
    access: "",
    url: "https://www.beeldengeluid.nl/collectie",
    keywords: "Science, technology and society; History of science and technology; Mediatechnology",
    description: "Beeld en Geluid offers online access to tens of thousands of hours of streaming video and audio material for higher education in the Netherlands, selected from the archives of the Netherlands Institute for Sound and Vision (Nederlands Instituut voor Beeld en Geluid). This Institute is more than just a platform for streaming video. It offers tools to help make lectures and assignments more attractive and inspiring with current and historical audiovisual material. The material can be used in all sorts of ways: as a support for a lecture or a presentation, or as a source for research. Sources: - Dutch public television broadcasts from 1955 to the present; - Polygoon cinema news programs; - Amateur recordings (cinefilm); - Corporate films; - Film and Science Foundation (Stichting Film- en Wetenschap); - Government Information Service (Rijksvoorlichtingsdiensts RVD) materials; - Collections of film makers and documentary makers; - Various audiovisual collections, such as Zendtijd Politieke Partijen (political party broadcats), Natuurbeelden (Images from Nature), Wisebits; - Radio and music collections.",
    type: "reference"
  },
  {
    title: "Beheer en onderhoud: Bouwkosten.nl",
    access: "",
    url: "https://www.beheerenonderhoudkosten.nl/",
    keywords: "Building physics and services; Building: design and construction; Building technology and construction process; Construction materials and building structures",
    description: "On this site you can find complete and substantiated cost data for effective property management and maintenance. It contains cost information in the field of architecture, technical installations, facilities and civil engineering.",
    type: "reference"
  },
  {
    title: "Besluit bouwwerken leefomgeving (Bbl)",
    access: "",
    url: "https://www.rijksoverheid.nl/onderwerpen/bouwregelgeving/bouwbesluit-2012",
    keywords: "Building policy; Building: design and construction; Safety engineering; Legislation",
    description: "A structure must not pose a danger to users and the environment. Therefore, the Dutch government has established rules for safety, health, usability, energy efficiency, and environmental protection in the 'Besluit bouwwerken leefomgeving' (Building Works Decree for the Living Environment), formerly known as the 'Bouwbesluit' (Building Decree). A structure must always comply with these rules.",
    type: "reference"
  },
  {
    title: "BIOSIS Citation Index",
    access: "",
    url: "https://www.webofscience.com/wos/bci/basic-search",
    keywords: "Biology; Biomedical engineering; Microbiology; Biotechnology",
    description: "BIOSIS Citation Index is the world's most comprehensive reference database for life science research. It includes cited references to primary journal literature on vital biological research, medical research findings, and discoveries of new organisms. It also covers original research reports and reviews in traditional biological and biomedical areas. Database Coverage: 1926 to present. Coverage includes traditional areas of biology such as: Botany, Zoology, Microbiology and related fields such as: biomedical, agriculture, pharmacology, ecology. Additionally, interdisciplinary fields such as: medicine, biochemistry, biophysics, boengineering, and biotechnology.",
    type: "articles"
  },
  {
    title: "BONAS Archiwijzer",
    access: "",
    url: "https://bonas.nl/archiwijzer/",
    keywords: "Architecture; Urban development and urban design",
    description: "The Archiwijzer is a search engine developed by BONAS (Bouw Ontwerp Nederland Architectuur Stichting). It documents thousands of architecture projects in the Netherlands. The search engine contains information about architects, designs, and buildings. You can search by architect, design, building, or location. The Archiwijzer also includes photos and drawings of architecture projects.",
    type: "reference"
  },
  {
    title: "Book Citation Index",
    access: "",
    url: "https://www.webofscience.com/wos/woscc/basic-search",
    keywords: "Scientific research",
    description: "The Book Citation Index (BKCI), part of the Web of Science (WoS) Core Collection, includes the published scholarly literature of books and book chapters selected by the WoS editorial staff. Book citations are seamlessly integrated with other citation databases in Web of Knowledge to provide a complete citation count of an author's published work. These citations are included in the overall citation count of a published work. Use these databases to track who is citing your published works and the published works of your peers. BCI constists of Book Citation Index - Science (BKCI-S) and Book Citation Index - Social Science & Humanities (KKCI-SSH). Please note that textbooks, encyclopedias, and reference books are not included in the Book Citation Index.",
    type: "articles"
  },
  {
    title: "Bouwkosten.nl",
    access: "",
    url: "https://www.bouwkosten.nl/",
    keywords: "Building technology and construction process; Building physics and services; Construction materials and building structures",
    description: "On Bouwkosten.nl you can find current and substantiated cost data for budgeting, calculation or tests on large scale and small scale construction projects and installation work. You will find, among other building component prices, material prices, hourly rates and an extensive archive of project analyzes and indexes. TU Delft has access to the Large-Scale Housing and Utility modules (Grootschalig Woningbouw and Utiliteitsbouw)",
    type: "reference"
  },
  {
    title: "Bouwwetten",
    access: "",
    url: "https://www.bouwwetten.nl/",
    keywords: "Building policy; Building: design and construction; Environmental policy; Legislation",
    description: "Bouwwetten (Construction law), formerly known as Omgeving in de Praktijk (Environment in Practice), is the website for Dutch building regulations, land use, planning, environment and cultural heritage. It is aimed at specialists working in the construction industry as well as architects, technical consultants, and municipal officials. Bouwwetten takes care of translating relevant legislation into daily construction and design practice. It provides current information, including explanations and comments written by experts. It provides a complete overview regarding environmental law, arranged for specific needs (in five well-organized files). Bouwwetten consists of current information such as daily news, agenda and vacancies; in-depth articles, legislation and case law; and highly reliable information from experts in the field.",
    type: "reference"
  },
  {
  ...
  },
  {
    ...
    keywords: "Chemistry; Materials research; Safety engineering",
    description: "CAMEO Chemicals is a tool designed for people who are involved in hazardous material incident response and planning. This tool is part of the CAMEO software suite, and it is available as a website, mobile website, and as a downloadable version that you can run on your own computer. CAMEO Chemicals contains: a library with thousands of datasheets containing response-related information and recommendations for hazardous materials that are commonly transported, used, or stored in the United States; a reactivity prediction tool, which you can use to predict potential reactive hazards between chemicals. CAMEO Chemicals was developed by the National Oceanic and Atmospheric Administration's (NOAA) Office of Response and Restoration in partnership with the Environmental Protection Agency's (EPA) Office of Emergency Management and the U.S. Coast Guard's (USCG) Research and Development Center.",
    type: "reference"
  },
  {
  ...
  },
  {
    ...
    keywords: "Chemistry; Chemical process engineering; Chemical technology",
  ...
  },
  {
    ...
    keywords: "Computer systems and computer networks; Informatics general; Information science; Information systems, databases",
    description: "CiteSeerX is a scientific literature digital library and search engine that focuses primarily on the literature in computer and information science. It aims to improve the dissemination of scientific literature and to provide improvements in functionality, usability, availability, cost, comprehensiveness, efficiency, and timeliness in the access of scientific and scholarly knowledge. Rather than creating just another digital library, CiteSeerX attempts to provide resources such as algorithms, data, metadata, services, techniques, and software that can be used to promote other digital libraries. CiteSeerx has developed new methods and algorithms to index PostScript and PDF research articles on the Web.",
    type: "articles"
  },
  {
    title: "Clarksons Shipping Intelligence Network",
    access: "Students can gain access within the TU network by creating an account via the link below (based on their TU Delft e-mail address): https://www.clarksons.net/Portal/Account/Register#/",
    url: "https://sin.clarksons.net/",
    keywords: "Marine building and outfitting; Shipping and ship control",
    description: "Clarksons Shipping Intelligence Network (SIN) provides access to 100,000 pages of data - a source of information about the shipping industry. SIN contains a comprehensive range of data collected and published by Clarksons Research, including the latest information on the shipping markets at glance, easily downloadable versions of its wide range periodicals, extensive fleet and orderbook listings, and thousands of time-series and graphs of key commercial information.",
    type: "reference"
  },
  {
    title: "Clarksons World Fleet Register",
    access: "Students can gain access within the TU network by creating an account via the link below (based on their TU Delft e-mail address): https://www.clarksons.net/Portal/Account/Register#/",
    url: "https://www.clarksons.net/wfr/",
    keywords: "Shipping and ship control; Ships and special craft",
    description: "The Clarksons Research World Fleet Register (WFR) provides provides comprehensive, authoritative and timely information and details of up to 150,000 ships above 100 gt. Using WFR you can “drill down” on vessel specifications, machinery, flag, class, incident history, owner detail, builder details. In addition WFR provides context through reports, rankings, time series, graphs and profiles for those needing information for operations or intelligence for marketing or strategy.",
    type: "reference"
  },
  {
    title: "Computer Index of Nuclear Reaction Data (CINDA)",
    access: "",
    url: "https://www-nds.iaea.org/exfor/cinda.htm",
    keywords: "Nuclear reactors and reactor physics; Nuclear technology",
    description: "CINDA contains bibliographic references to measurements, calculations, reviews, and evaluations of neutron cross-sections and other microscopic neutron data; it also includes index references to computer libraries of numerical neutron data available from four regional neutron data centers. Since 2005, database is extended by photonuclear and charged particle reaction data. Missing data are automatically imported from EXFOR (since 2005) and from NSR (since 2010).",
    type: "research data"
  },
  {
    title: "CORDIS",
    ...
    keywords: "Scientific research",
    description: "CORDIS, the Community Research and Development Information Service for Science, Research and Development, is the official source of information on the framework programmes calls for proposals; it offers interactive web facilities that links together researchers, policymakers, managers and key players in the field of research.",
    type: "reference"
  },
  {
    title: "CROW Online Kennisbank",
    access: "Log in with your NETID with SURFconext.",
    url: "https://kennisbank.crow.nl/idp/surfnet",
    keywords: "Traffic and transport; Infrastructure; Urban and regional development",
    description: "CROW Online Kennisbank is an online reference work of CROW publications (mostly in Dutch) - encompassing a wealth of relevant CROW knowledge products in the domains of infrastructure, traffic and transport, and public space. The knowledge base is organized into a series of knowledge modules, including Contracting, Procurement, Asset Management, Asphalt Pavements, Motorways, Public Space Management, Concrete Pavements, Trees, Bicycle Traffic, Foundations and Vibrations, Freight Transport, Groundwork and Foundations, Parking, Space, Mobility, Urban Planning and Traffic, Traffic Management, Road Signs, Road Safety and Accessibility, Pedestrians, Road Management, Inspections and Measurements, Road Design, and Working in and with Contaminated Soil.",
    type: "reference"
  },
  {
    title: "CumInCAD",
    access: "",
    url: "https://papers.cumincad.org/",
    keywords: "Architecture; Computer graphics and computer simulation; Building: design and construction",
    description: "CumInCAD is a comprehensive index of publications related to computer-aided architectural design. It contains bibliographic information on records from various journals and conferences, including ACADIA, ASCAAD, CAADRIA, eCAADe, SiGraDi, CAAD futures, DDSS, and others. All papers come with full abstracts, and the majority of papers are also available in full-text PDF format. The IBPSA-website provides direct access to published papers related to building performance.",
    type: "articles"
  },
  {
    title: "CUR Rapporten",
    access: "",
    url: "https://www.briswarenhuis.nl/modules/cur-rapporten",
    keywords: "Civil engineering; Building technology and construction process; Building: design and construction; Construction materials and building structures",
    description: "CUR Rapporten is an online collection of reports published by the Dutch Civil Engineering Centre for the Execution of Research and Regulation (Civieltechnisch Centrum Uitvoering Research en Regelgeving - CUR). These reports describe new and innovative methods and techniques for construction and civil engineering. The publications, primarily written in Dutch, aim to present CUR-associated research results in an accessible way. Some reports serve as guidelines, illustrating how a structure should be designed and the subsequent building process executed.",
    type: "reports"
  },
  {
    title: "Current Chemical Reactions",
    access: "",
    url: "https://www.webofscience.com/wos/woscc/basic-search",
    keywords: "Chemistry",
    description: "Current Chemical Reactions, part of Web of Science Core Collection: Chemical Indexes, contains single- and multi-step new synthetic methods taken from leading journals and patents from 36 issuing authorities. The overall reaction flow is provided for each method, along with a detailed and accurate graphical representation of each reaction step. Coverage: 1985 to present. It also includes an additional 140,000 structure data records from the prestigious Institut National de la Propriété Industrielle (INPI) dating back to the 1840. INPI is the national intellectual property office of France. It is in charge of patents, trademarks, and industrial design rights.",
    type: "articles"
  },
  {
    title: "Current Contents Connect",
    access: "",
    url: "https://www.webofscience.com/wos/ccc/basic-search",
    keywords: "Scientific research",
    description: "Current Contents Connect is a multidisciplinary current awareness Web resource providing access to complete bibliographic information of the world's leading scholarly journals. Current Contents Connect allows you to search a premium collection of evaluated scholarly Web sites and access evaluated, full-text Web documents in three general resource types: preprints, funding information, and research activities. Available editions and collections: Agriculture, Biology & Environmental Sciences (ABES); Social & Behavioral Sciences (SBS); Clinical Medicine (CM); Life Sciences (LS); Physical, Chemical & Earth Sciences (PCES); Engineering, Computing & Technology (ECT); Arts & Humanities (AH); Business Collection (BC); Electronics & Telecommunications Collection (EC) . Database Coverage: 1998 to the present.",
    type: "articles"
  },
  {
    title: "Data Citation Index",
    access: "",
    url: "https://www.webofscience.com/wos/drci/basic-search",
    keywords: "Scientific research",
  ...
  },
  {
    ...
    keywords: "Informatics general; Information systems, databases; Computer systems and computer networks",
    description: "The DBLP computer science bibliography is an on-line reference for bibliographic information on major computer science publications. It has evolved from an early small experimental web server to a popular open-data service for the computer science community. Our mission at dblp is to support computer science researchers in their daily efforts by providing free access to high-quality bibliographic meta-data and links to the electronic editions of publications. DBLP currently indexes over 2.6 million publications, published by more than 1.4 million authors. To this end, dblp indexes about than 25000 journal volumes, more than 24000 conferences or workshops, and more than 17000 monographs.",
    type: "articles"
  },
  {
    title: "Delpher",
  ...
  },
  {
    ...
    keywords: "Scientific research",
    description: "The aim of the DOAJ is to increase the visibility and ease of use of open access scientific and scholarly journals, thereby promoting their increased usage and impact. The DOAJ aims to be comprehensive and cover all open access scientific and scholarly journals that use a quality control system to guarantee the content.",
    type: "articles"
  },
  {
    title: "Earthdoc",
    access: "",
    url: "https://www.earthdoc.org/",
    keywords: "Earth sciences; Geology; Geophysics; Geotechnics, underground construction",
    description: "EarthDoc is EAGE (European Association of Geoscientists and Engineers)’s geoscience and engineering database with event extended abstracts, technical articles and journal papers. The database includes material from EAGE technical journals. Not everything is full text. Papers from EAGE events are available two weeks prior to the (conference) event.",
    type: "articles"
  },
  {
    title: "ECHA: Advanced search for Chemicals",
    access: "",
    url: "https://echa.europa.eu/advanced-search-for-chemicals",
    keywords: "Chemical process engineering; Chemistry; Safety engineering; Toxicology",
    description: "The European Chemicals Agency (ECHA) provides a unique source of information on chemicals manufactured and imported in Europe, covering their hazardous properties, classification, and labeling. The Advanced Search for Chemicals tool allows users to search for specific substances and access information on their properties, classification, and labeling. The ECHA website also provides information on registered substances that can be placed on the European Economic Area market by companies with valid registration. Please be aware that ECHA has released a new Data Availability System at the beginning of 2024, which may eventually replace ECHA: Advanced search for Chemicals.",
    type: "reference"
  },
  {
    title: "ERIC Education Resources Information Center",
    access: "",
    url: "https://urldefense.com/v3/__https:/search.ebscohost.com/login.aspx?authtype=sso&custid=s1131660&groupid=main&profile=ehost&defaultdb=eric__;!!PAKc-5URQlI!9Zu7lF7UbtETWEnzX_S15j8G8w8D_Wx9Kn0u1A_vL_G0NPTbFNkSYyKJ7hB5AwnLVWvDnhQx5x4LxytdVFaDCg$",
    keywords: "Education",
    description: "ERIC (Education Resources Information Center) is a comprehensive bibliographic and full-text database of education research and information. ERIC is an authoritative database of indexed and full-text education literature and resources. Sponsored by the Institute of Education Sciences of the U.S. Department of Education, it is an essential tool for education researchers of all kinds. ERIC includes records for a variety of source types, including journal articles, books, conference papers, curriculum guides, dissertations and policy papers. Further, researchers can limit search results by education level such as Early Childhood Education as well as on the intended audience such as Counselors or Teachers.",
    type: "articles"
  },
  {
    title: "ESDU",
    access: "",
    url: "https://www.esdu.com/",
    keywords: "Aeronautical engineering; Aeronautics and aircraft; Aerospace; Mechanical engineering",
    description: "ESDU contains a complete list of all the ESDU engineering design guides and associated software. In total the ESDU engineering design information is divided into 18 Series with more than 350 Sections containing over 1470 Data Item design guides with over 215 ESDUpac FORTRAN calculation codes and over 150 VIEWpac executable codes. In addition to the ESDU validated information various ancillary documentation from, for example, NACA and NASA is available.",
    type: "reference"
  },
  {
    title: "Espacenet",
  ...
  },
  {
    ...
    keywords: "Econometrics; Economics; Political science; Probability, statistics",
    description: "Eurostat's mission is to provide the European Union with a high-quality statistical information service. Eurostat is the statistical office of the European Union situated in Luxembourg. Its task is to provide the European Union with statistics at European level that enable comparisons between countries and regions.",
    type: "statistics"
  },
  {
    title: "Follow the Money",
    access: "",
    url: "https://www.ftm.nl/artikelen",
    keywords: "Economics; Political science; Science, technology and society; Sociology, demography and social structure",
    description: `Follow the Money (FTM) is an independent Dutch news website that focuses on financial and economic affairs investigative journalism. Its stated primary goal is to uncover the truth in the service of society, and it aims to serve as a watchdog for issues related to healthcare, the housing market, and politics. The website's editorial motto, "Follow the money," has become part of the national lexicon and suggests that political corruption can be uncovered by examining money transfers between parties.`,
    type: "articles"
  },
  {
    title: "Gartner",
    access: "",
    url: "https://ssofed.gartner.com/sp/startSSO.ping?PartnerIdpId=https%3A%2F%2Fengine.surfconext.nl%2Fauthentication%2Fidp%2Fmetadata",
    keywords: "Business economics; Business information systems; Decision making; Management",
    description: "Gartner provides information on technology research that can help to make informed decisions on key initiatives. TU Delft provides access to the following sections of the Gartner website: events and webinars, news and research reports, and the two main data visualization and analysis tools: Gartner Magic Quadrants and the Hype Cycle. Gartner Magic Quadrants is a research methodology and visualization tool for monitoring and evaluating the progress and positions of companies in a specific, technology-based market. Magic Quadrants uses a two-dimensional matrix to illustrate the strengths and differences between companies. Research reports generated help investors find companies that fit their needs and help businesses compare competitors in their market. The Hype Cycle is a graphical representation of the life cycle stages a technology goes through from conception to maturity and widespread adoption. The hype cycle’s stages are often used as reference points in marketing and technology reporting; businesses can use the hype cycle to guide technology decisions in accordance with their level of comfort with risk.",
    type: "reference"
  },
  {
    title: "GlobaLex",
  ...
  },
  {
    ...
    keywords: "Scientific research",
    description: "The Highly Cited Researchers list, compiled by Clarivate, identifies scientists who have demonstrated significant influence through the publication of multiple highly cited papers over the last decade. These highly cited papers rank in the top 1% by citations for a specific field or fields and publication year in the Web of Science. Being included in this list is a prestigious recognition, as Highly Cited Researchers represent only 1 in 1,000 scientists and social scientists worldwide. The list covers 21 broad fields and researchers are selected based on their exceptional performance in one or more of these fields.",
    type: "reference"
  },
  {
    title: "Hydraulic Engineering Reports",
    access: "",
    url: "https://repository.tudelft.nl/search?collection=hydraulic_reports",
    keywords: "Hydraulic engineering; Civil engineering",
    description: "Repository Hydraulic Engineering Reports is the digital source of public scientific reports (full text) of the Department of Hydraulic Engineering, part of Faculty Civil Engineering & Geosciences of TU Delft, and hydraulic engineering reports of other institutions and organisations. Researchers themselves, or their assistants, place their material in Repository Hydraulic Engineering Reports.",
    type: "reports"
  },
  {
    title: "Hydrotheek",
    access: "",
    url: "https://library.wur.nl/WebQuery/hydrotheek",
    keywords: "Hydrology; Ecology; Water management; Water management",
    description: "The Hydrotheek, maintained by the Foundation for Applied Water Research (STOWA), the online repository for publications about water in the Netherlands. The aim of the Hydrotheek is 100% digital, i.e. the full text of all publications is online and free available. Main subjects are hydrology, aquatic ecology, water control and management, and water treatment in the Netherlands.",
    type: "articles"
  },
  {
    title: "IAI.tv - Institute of Art and Ideas",
    access: "TU Delft does not have access to the six most recent months of content, and does not include Academy Courses.",
    url: "https://iai.tv/",
    keywords: "Science, technology and society; Philosophy; Political science; Art",
    description: "The Institute of Art and Ideas (IAI) is a non-profit organization dedicated to fostering and promoting philosophy and interdisciplinary thinking. It hosts events, lectures, and debates featuring leading thinkers and experts from various fields, including philosophy, science, politics, and the arts. The Institute's website, IAI.tv, provides articles, courses, and podcasts by various scholars and intellectuals on these topics. TU Delft does not have access to the six most recent months of content, and does not include Academy Courses.",
...
Check 'My subscriptions' and click on one of the TU Delft subscriptions 'Air & Space Module', 'Sea Module', 'News Module' and 'Company Intelligence'.`,
  ...
  },
  {
    ...
    keywords: "Scientific research; Writing and reporting",
    description: "Search one of the world’s largest crowd-sourced research catalogs on Mendeley. Get related research, refine your search to full-text PDFs and add papers to your library in one click.",
    type: "articles"
  },
  {
    ...
    keywords: "Aerospace; Aeronautical engineering; Aeronautics and aircraft; Space technology",
  ...
  {
    title: "NEN Connect: Dutch Accepted Standards",
    access: "TU Delft provides access to the complete NEN standards collection. Login with your NETID with SURFconext",
    url: "https://connect.nen.nl/Account/SSO/SURFconext",
    keywords: "Standardisation",
    description: "NEN Connect is an online database managed by the Royal Netherlands Standardization Institute. It provides access to all Dutch standards (NEN), European (EN), and international standards (ISO, IEC) accepted in the Netherlands. TU Delft provides access to the complete NEN Dutch Accepted Standards (Nederlands Aanvaard) collection. Log in with your NETID with SURFconext.",
    type: "standards"
  },
  {
    title: "Nexis Uni",
    access: "To use Nexis Uni, you must create an account. If you are having trouble accessing the database or are asked for a registration code during the account creation process, please install the Lean Library extension.",
    url: "https://www.nexisuni.com/",
    keywords: "Science, technology and society; Political science; Legislation; Social sciences",
    description: "Nexis Uni provides access to an extensive database encompassing major newspapers, legal documents, business information, and academic journals. Renowned international newspapers such as The New York Times, The Guardian, and The Financial Times can be found within Nexis Uni's collection. In addition to international newspapers, Nexis Uni also includes a selection of Dutch national newspapers. Examples of Dutch newspapers available on the platform include De Telegraaf, NRC Handelsblad, and De Volkskrant. The date range and update schedule differ per source.",
    type: "articles"
  },
  {
    title: "NIBE Nederlands Instituut voor Bouwbiologie en Ecologie",
    access: "Create a personal account to access the database.",
    url: "https://www.nibe.info/nl",
    keywords: "Environmental technology; Building technology and construction process; Safety engineering; Construction materials and building structures",
    description: "The NIBE.INFO database contains a vast set of health and environmental and cost data of building products. The database is based on the Nationale Milieu Database (National Environmental Database). You have to create a personal account to access the database.",
    type: "reference"
  },
  {
    title: "NIST Atomic Reference Data for Electronic Structure Calculations",
    access: "",
    url: "https://www.nist.gov/pml/atomic-reference-data-electronic-structure-calculations",
    keywords: "Atomic and molecular physics",
    description: "This site gives access to generated data for atomic electronic structure calculations, to provide a standard reference for results of specified accuracy under commonly used approximations. Results are presented for total energies and orbital energy eigenvalues for all atoms from H to U, at microHartree accuracy in the total energy, as computed in the local-density approximation (LDA) the local-spin-density approximation (LSD); the relativistic local-density approximation (RLDA); and scalar-relativistic local-density approximation (ScRLDA).",
    type: "reference"
  },
  {
    ...
    keywords: "Atomic and molecular physics",
    description: "This database provides access and search capability for NIST critically evaluated data on atomic energy levels, wavelengths, and transition probabilities that are reasonably up-to-date. The Atomic Energy Levels Data Center and Data Center on Atomic Transition Probabilities and Line Shapes have carried out these critical compilations. Both Data Centers are located in the Physical Measurement Laboratory at the National Institute of Standards and Technology (NIST).",
    type: "reference"
  },
  {
    title: "NIST Fire Research Division",
    access: "",
    url: "https://www.nist.gov/el/fire-research-division-73300",
    keywords: "Building physics and services; Safety engineering; Building: design and construction; Construction materials and building structures",
    description: "This website contains a collection of over 4500 publications related to fire and building research. These publications were produced by or for NIST staff mostly between 1993 and 2010. It also contains a selected number of documents published before 1993.",
    type: "reports"
  },
  {
    title: "NIST Reference on Constants, Units, and Uncertainty",
    access: "",
    url: "https://physics.nist.gov/cuu/Constants/Citations/Search.html",
    keywords: "Physics general",
    description: "This units and measurement website contains fundamental physical constants, the International System of Units (SI), or metric system, and information on uncertainty of measurements, as well as a searchable bibliography of related papers. It provides an online conversion utility for converting between energy units and descriptive histories of standards of measurement.",
    type: "reference"
  },
  {
    title: "Nuclear Science References (NSR)",
    access: "",
    url: "https://www.nndc.bnl.gov/nsr/",
    keywords: "Nuclear physics; Nuclear engineering; Nuclear technology; Nuclear reactors and reactor physics",
    description: "The NSR database is a bibliography of nuclear physics articles, indexed according to content and spanning more than 100 years of research. Over 80 journals are checked on a regular basis for articles to be included.",
    type: "articles"
  },
  {
    title: "OAIster",
    access: "",
    url: "https://oaister.on.worldcat.org/discovery",
    keywords: "Scientific research",
    description: "OAIster is a union catalog of millions of records representing open access resources that was built by harvesting from open access collections worldwide using the Open Archives Initiative Protocol for Metadata Harvesting (OAI-PMH). OAIster includes more than 30 million records representing digital resources from more than 1,500 contributors.",
    type: "articles"
  },
  {
    title: "OECD",
    access: "",
    url: "https://www.oecd.org/en/search.html?orderBy=mostRelevant&page=0",
    keywords: "Probability, statistics; Econometrics; Economics",
    description: "The OECD provides internationally comparable socio-economic and environmental statistics. It collects data from member and partner countries, monitors trends, analyzes economic developments, and conducts research on social changes. In addition to publishing reports, the OECD offers open access to its research and data, supporting evidence-based policymaking worldwide. Its website allows users to search for publications, access data (including dashboards and tools), and stay updated on news and events.",
    type: "statistics"
  },
  {
    title: "OnePetro",
  ...
  },
  {
    ...
    keywords: "Scientific research",
    description: "OpenDissertations is an open-access database built to assist researchers in locating both historic and contemporary dissertations and theses. It incorporates EBSCO’s previously released American Doctoral Dissertations, and features additional dissertation metadata contributed by select colleges and universities from around the world.",
    type: "theses"
  },
  {
    title: "OpMaat Premium Plus",
    access: "",
    url: "https://opmaat.sdu.nl/",
    keywords: "Legislation; Law; Political science",
    description: "Opmaat Premium Plus contains full text Government Publications, Dutch Legislation, Issuing of Rules, Case law, articles from SDU legal journals on case law, news, dossiers, EU Legislation, case law and treaties.",
    type: "reference"
  },
  {
    title: "O'Reilly for Higher Education",
    access: "",
    url: "https://urldefense.com/v3/__http:/tudelft.idm.oclc.org/login?url=https:**Awww.oreilly.com*library-access**Aemail=*5Eu__;Ly8vLz8l!!PAKc-5URQlI!8W9eEbnUrNrYfIegUl04sEMbKaoAYY4hlqVPI4Ap8mbkth9G-XwZMls3X8EqBqmYQBtJ0UzEpwI-ZY2Yby9mRrA$",
    keywords: "Computer systems and computer networks; Information science; Informatics general; Business information systems",
    description: "The O'Reilly Higher Education Platform provides access to an extensive library of e-books, video courses, interactive learning paths, and case studies from renowned publishers and industry experts. The content covers a diverse range of subjects, including computer science, data science, business, engineering, and many others. Users can explore topics such as programming languages, machine learning, cybersecurity, and project management, among others. One of the standout features of the platform is its focus on hands-on learning. Users can access virtual labs and coding environments to practice their skills and gain practical experience. These interactive exercises and simulations enable learners to apply theoretical concepts in a real-world context.",
    type: "e-books"
  },
  {
    title: "OSTI.GOV",
    ...
    keywords: "Scientific research; Energy technology",
    description: "The OSTI.GOV database is the primary search tool for Department of Energy (DOE) funded science, technology, and engineering research and development (R&D) results. It provides access to over 70 years of research results, including journal articles, technical reports, scientific research datasets, scientific software, patents, and more. The database offers two categories of records: Full Text/Resource Available and Citation Only.",
    type: "articles"
  },
  {
    title: "Overheid.nl",
    ...
    keywords: "Legislation; Political science; Policy analysis; Law",
    description: "Overheid.nl is the central access point to all information about government organisations of the Netherlands.'Dutch government websites' provides a selection of websites on subjects such as tourism, trade and culture. You will also find links to the English-language pages of the websites of Dutch government organisations. Under 'About the Dutch government' you will find information on how Dutch government services are organised.",
    type: "reference"
  },
  {
    title: "PEER Ground Motion Database",
    access: "To access the PEER Ground Motion Database, users are required to register",
    url: "https://ngawest2.berkeley.edu/",
    keywords: "Geophysics; Geology; Earth sciences",
    description: "The Pacific Earthquake Engineering Research Center (PEER) Ground Motion Database is a web-based database that provides tools for searching, selecting, and downloading ground motion data. The database consist of two separate sections: NGA West2 Shallow Crustal Earthquakes in Active Tectonic Regimes and NGA East Central and Eastern North-America. The NGA West2 ground motion database includes a very large set of ground motions recorded in worldwide shallow crustal earthquakes in active tectonic regimes. The database has one of the most comprehensive sets of meta-data, including different distance measure, various site characterizations, earthquake source data, etc. The current version of the database is similar to the NGA West2 database, which was used to develop the 2014 NGA West2 ground motion models (GMMs). The objective of NGA East is to develop a new ground motion characterization (GMC) model for the Central and Eastern North-American (CENA) region. The GMC model consists in a set of new ground motion models (GMMs) for median and standard deviation of ground motions (GMs) and their associated weights in the logic-trees for use in probabilistic seismic hazard analyses (PSHA).",
    type: "research data"
  },
  {
    title: "Philpapers",
  ...
  },
  {
    ...
    keywords: "Biomedical engineering; Biochemistry",
    description: "PubMed comprises 36m+ citations for biomedical literature from MEDLINE, life science journals, and online books. Citations may include links to full-text content from PubMed Central and publisher web sites.",
    type: "articles"
  },
  {
    title: "re3data: Registry of Research Data Repositories",
    access: "",
    url: "https://www.re3data.org/search",
    keywords: "Scientific research",
    description: "re3data is a global registry of repositories. The registry covers repositories from different academic disciplines. re3data presents repositories for the storage of data sets to researchers, funders, publishers and scholarly institutions. re3data aims to promote a culture of sharing, increased access and better visibility of research data. re3data helps researchers to find appropriate repositories for the storage and access of research data. Further, it can be used by funders to promote permanent access to research data from their funded research projects. In addition re3data offers publishers and academic institutions a tool for the identification of repositories where scientists can deposit their data.",
    type: "research data"
  },
  {
    title: "Reaxys",
  ...
  },
  {
    ...
    access: "",
    url: "https://www.lib.tudelft.nl/scifinderregistration/",
    keywords: "Biomedical engineering; Chemistry; Materials engineering; Scientific research",
    description: "SciFinder-n is a research discovery tool that allows you to explore the CAS databases containing literature from many scientific disciplines including biomedical sciences, chemistry, engineering, materials science, agricultural science, and more. SciFinder-n retrieves information contained in databases produced by Chemical Abstracts Service (CAS) as well as in the MEDLINE database of the National Library of Medicine (NLM). SciFinder-n features the CAS Content Collection: Substances, CAS References, CAS Reactions, CAS Chemical Supplier Insights, Chemical Regulation and CAS Markush Representations in Patents. The Substances module contain chemical names, structures, CAS Registry Numbers and covers organic and inorganic substances, including alloys, coordination compounds, minerals, mixtures, polymers, and salts, protein and nucleic acid sequences and enriched with experimental and predicted property data and spectra. CAS References are sourced from thousands of journals, patent authorities as well as technical reports, books, conference proceedings and dissertations. They are also enhanced with English language summaries for non-English publications, standardized CAS Lexicon terminology indexing, cited and citing references, legal status, and direct links to the full-text publications (where available). CAS Reactions provides a current and reliable source of synthetic details sourced from journals, patents, dissertations, and seminal reference works. This module covers reactions including organometallics, total syntheses of natural products, and biotransformation reactions which are ehanced with yield data, detailed reaction conditions, and experimental procedures. CAS Chemical Supplier Insights provides an up-to-date resource for finding commercially available chemicals, including available quantities, prices, and supplier contact information. Chemical Regulations covers a vast number of unique chemical substances, as well as information from numerous regulatory inventories and lists. Finally, CAS Markush Representations in Patents are prepared by CAS to make them searchable to ensure that your queries don’t miss critical documents. A one-time registration with NetID is required. Go to: https://www.lib.tudelft.nl/scifinderregistration/",
    type: "patent information"
  },
  ...
  },
  {
    ...
    keywords: "Toxicology; Biomedical engineering; Biochemistry; Biotechnology",
    description: "Springer Nature Experiments is a research solution for laboratory procedures that offers a vast collection of protocols and methods from SpringerProtocols, Nature Protocols, and Nature Methods. The platform covers a wide range of subject areas in the life sciences, including Biochemistry, Bioinformatics, Biotechnology, Cancer Research, Cell Biology, Genetics/Genomics, Imaging, Immunology, Infectious Diseases, Microbiology, Molecular Medicine, Neuroscience, Pharmacology and Toxicology, Plant Science, and Protein Science.",
    type: "reference"
  },
  {
    ...
    keywords: "Materials research; Physical chemistry; Physics general; Safety engineering",
    description: "SpringerMaterials provides access to curated data about 3000+ physical and chemical properties of 250,000+ materials and chemical systems. Data sources currently include the Landolt-Börnstein New Series (Beta Status), the Linus Pauling Files and specialized databases on thermophysical properties, polymer thermodynamics, adsorption isotherms, and 32,000+ substance profiles.",
    type: "articles"
  },
  {
    title: "Statista.com",
    ...
    keywords: "Business information systems; Business economics; Consumer behaviour",
    description: "The Statista platform contains statistics and market reports on more a vast range of topics from numerous sources and different industries. Statistics and survey results are presented in charts and tables, including infographics. The data covers, among other things country and company information, advertisement, buying behavior or specific industries.",
    type: "statistics"
  },
  {
    title: "StatLine",
    access: "Most information also available in English",
    url: "https://opendata.cbs.nl/statline/",
    keywords: "Econometrics; Economics; Sociology, demography and social structure; Probability, statistics",
    description: "Statistics Netherlands (Centraal Bureau voor de Statistiek) is responsible for collecting and processing data in order to publish statistics to be used in practice, by policymakers and for scientific research. In addition to its responsibility for (official) national statistics, Statistics Netherlands also has the task of producing European (community) statistics. The information Statistics Netherlands publishes incorporates a multitude of societal aspects, from macro-economic indicators such as economic growth and consumer prices, to the incomes of individual people and households. Statistics Netherlands’ statistical programmes (the long-term statistical programme and the annual work programme) are set by the Central Commission for Statistics. StatLine is the electronic databank of Statistics Netherlands. It enables users to compile their own tables and graphs.",
    type: "statistics"
  },
  {
    title: "Structurae: International Database and Gallery of Structures",
    access: "Registration is required to access this free database",
    url: "https://structurae.net/en",
    keywords: "Architecture; Building: design and construction",
    description: "Structurae is an online database and gallery of structures and large-scale projects. It contains information on structures from around the world, including bridges, tunnels, dams, skyscrapers, stadiums, towers, and more. The database also includes a literature index. Structurae is a valuable resource for civil and structural engineers, architects, builders, and anyone interested in learning more about the world's most impressive structures. The database provides detailed information on each structure, including its history, design, construction, and technical specifications. There are also images, videos, and 3D models of many of the structures. In addition to the database, Structurae also offers a number of other resources, including a listing of companies and engineering offices in the construction sector, products and services for the construction sector, biographies of engineers, builders, and architects, and a geographic guide to civil/structural engineering.",
    type: "reference"
  },
  {
    title: "Teacher Reference Center",
    access: "",
    url: "https://urldefense.com/v3/__https:/search.ebscohost.com/login.aspx?authtype=sso&custid=s1131660&groupid=main&profile=ehost&defaultdb=trh__;!!PAKc-5URQlI!9Zu7lF7UbtETWEnzX_S15j8G8w8D_Wx9Kn0u1A_vL_G0NPTbFNkSYyKJ7hB5AwnLVWvDnhQx5x4LxyuJ7bXCiA$",
    keywords: "Education; Management; Mathematics",
  ...
  },
  {
    title: "Toxic",
    access: "",
    url: "https://app.toxic.nl/en/frontend/published/nrzrmkhdknmpijwadizmzbigoxcspp/workplaceproduct/",
    keywords: "Chemical process engineering; Chemistry; Safety engineering; Toxicology",
    description: 'Toxic provides access to (safety) data of chemical substances. This large collection of Safety Data Sheets incorpates the collection formerly known as "Chemiekaarten". You can search on product name, product code, CAS-number, or UN-number. You can also filter on collection "Chemiekaarten". For each substance there is a separate page where you may quickly find the information you need: identification, physical characteristics, symptoms, emergencies and disposal, prevention, first aid, and transport regulations.',
    type: "reference"
  },
  {
    title: "TranStats",
  ...
  },
  {
    ...
    keywords: "Traffic and transport; Mobility studies; Infrastructure; Building technology and construction process",
    description: "TRID is an integrated database that combines the records from TRB's Transportation Research Information Services (TRIS) Database and the OECD's Joint Transport Research Centre’s International Transport Research Documentation (ITRD) Database. TRID provides access to over 940,000 records of transportation research worldwide. Subject categories: administration and management, aviation, bridges and other structures, construction, data and information technology, design, economics, education and training, energy, environment, finance, freight transportation, geotechnology, highways, history, hydraulics and hydrology, law, maintenance and preservation, marine transportation, materials, motor carriers, operations and traffic management, passenger transportation, pavements, pedestrians and bicyclists, pipelines, planning and forecasting, policy, public transportation, railroads, research, safety and human factors, security and emergencies, society, terminals and facilities, transportation (general), vehicles and equipment.",
    type: "articles"
  },
  {
    title: "TU Delft Maps",
    access: "Login with NetID required",
    url: "https://www.tudelft.nl/en/library/collections/map-room/",
    keywords: "Geodesy; Geographical information",
    description: "This website gives access to the complete digital map of the Netherlands scale 1:10.000 (TOP10vector) or scale 1:50.000 (TOP50NL). TOP10vector and TOP50NL are country-wide vector map files of the Netherlands. Its vectors provide coded descriptions referring to a theme and possibly a classification. The data can be used to analyse and visualise specific themes in a GIS, possibly in combination with other site-related data. The vector structure provides considerable control over the final result. you can search for a location by typing a place name, the name of any region or postcode in the TU Delft Maps search box. You can only use the first four digits of a Dutch postal code. You can download a topographical map in PDF format, in Shapefile format and in GML format. The application is available by access to the SURFfederation. Select your organisation and login with your NetID/password (at this moment only available for TU Delft students and staff and for students and staff of the VU Amsterdam). The digital maps may be accessed from outside the campus.",
    type: "reference"
  },
  {
  ...
  },
  {
    ...
    keywords: "Sociology, demography and social structure; Science, technology and society",
    description: 'UNdata is a web-based data service for the global user community. It brings international statistical databases within easy reach of users through a single-entry point. Users can search and download a variety of statistical resources compiled by the United Nations (UN) statistical system and other international agencies. The numerous databases or tables collectively known as "datamarts" contain over 60 million data points and cover a wide range of statistical themes including agriculture, crime, communication, development assistance, education, energy, environment, finance, gender, health, labour market, manufacturing, national accounts, population and migration, science and technology, tourism, transport and trade. In addition to the "datamarts", the following additional resources are provided as links: specialized databases external to UNdata, such as UNComtrade, SDG indicators and MBS Online; popular Statistical Tables produced as part of the UN Statistical Yearbook publication; statistical profiles of countries (areas) and regions produced as part of the World Statistics Pocketbook publication.',
    type: "statistics"
  },
  {
    title: "Van Dale Online Woordenboeken",
    access: "",
    url: "https://urldefense.com/v3/__https://surfconext.vandale.nl/api/zoeken/managesurfconextprocess__;!!PAKc-5URQlI!__RN6usA7ymxiLCH8mzI13C27bJ74lWcKzboWjaNoW-vfu2M6LrRaQxhrSkBZoe_TWXw5W5T7kMRAmJSfY_MaVaNNQ$",
    keywords: "Language",
    description: 'Online access to a wide range of Van Dale dictionaries: Groot Woordenboek der Nederlandse Taal ("Dikke Van Dale", unabridged Dutch dictionary); Van Dale Nederlands Woordenboek (standard Dutch dictionary); Handboek Nederlands (Handbook Dutch); and Van Dale bilingual bidirectional databases: Nederlands-Engels (Dutch-English), Nederlands-Frans (Dutch-French), Nederlands-Duits (Dutch-German), Nederlands-Spaans (Dutch-Spanish), Nederlands-Italiaans (Dutch-Italian), Nederlands-Portugees (Dutch-Portuguese); Nederlands-Zweeds (Dutch-Swedish).',
    type: "reference"
  },
  {
    title: "Vessel Register for DNV",
    access: "",
    url: "https://vesselregister.dnv.com/vesselregister/",
    keywords: "Ships and special craft; Marine building and outfitting; Naval architecture",
    description: "The Vessel Register for DNV contains all vessels serviced by DNV. You can search by using IMO number, DNV vessel identity, manager and owner name, flag (three letter codes or Flag name), ship type, port of registry, call sign and official number.",
    type: "reference"
  },
  {
    title: "Waterinfo",
  ...
  },
  {
    ...
    keywords: "Industrial design; Design for mass production; Industrial design products",
    description: "The WIPO Global Brand Database is a free online resource that provides access to information on trademarks, appellations of origin, and official emblems from multiple national and international sources. The database can be used to search for brands by text or image, and it also provides information on the status of brands, including whether they are registered or pending.",
    type: "reference"
  },
  {
  ...
  },
  {
    ...
    getRecords: async function(query) {
      try {
        ...
        const results = query ? databases_default.filter(filter(query)) : databases_default;
...
async function createResults(searchInput) {
  ...
  if (grid) {
    ...
    providers_default.map(async (provider) => {
      ...
      const container = document.querySelector("#" + provider.id);
      if (container) {
